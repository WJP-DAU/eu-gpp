...
global dataName "Latvia_FFW_20240524.sav"
...
/* Note:
	For some polling companies such as Bilendi and IPSOS, we are splitting the raw data per country but this is just
