...
gen nuts_ltn =""
replace nuts_ltn="Sostines regionas" if region=="Vilnius"

local r "Alytus Kaunas Klaipeda Marijampole Panevezys Siauliai Taurage Telsiai Utena" 
foreach v in `r' {
replace nuts_ltn="Vidurio ir vakaru Lietuvos regionas" if region=="`v'"
}

gen nuts_id = ""
replace nuts_id="LT01" if region=="Vilnius"

local r "Alytus Kaunas Klaipeda Marijampole Panevezys Siauliai Taurage Telsiai Utena" 
foreach v in `r' {
replace nuts_id="LT02" if region=="`v'"
}
...
rename ID-COLOR, lower

rename (*_g1) (*_G1)
rename (*_g2) (*_G2)
rename a1 a2 a3 a4 a6 a7 b1-b3, proper
rename (a5a_1 a5a_2) (A5_1 A5_2)
...
rename urban income2 city region, p
rename color psu ssu, u
rename interview_lenght Interview_length

forvalues i=1/3 {
forvalues y=1/3 {
rename g60_g`i'_`y' q60_G`i'_`y'
}
}
